...
private const val TAG = "AGMobileClawWebView"
...
/**
 * A base [WebViewClient] for [MobileClawWebView] that handles local asset loading and logs page
 * finishing.
 */
open class BaseMobileClawWebViewClient(private val context: Context) : WebViewClient() {
...
fun MobileClawWebView(
  ...
  val curWebViewClient = remember {
    customWebViewClient ?: BaseMobileClawWebViewClient(context = context)
  }
