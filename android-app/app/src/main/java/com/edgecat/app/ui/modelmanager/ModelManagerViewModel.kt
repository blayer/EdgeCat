...
package com.edgecat.app.ui.modelmanager
...
import com.edgecat.app.BuildConfig
import com.edgecat.app.R
import com.edgecat.app.common.ProjectConfig
import com.edgecat.app.common.getJsonResponse
import com.edgecat.app.customtasks.common.CustomTask
import com.edgecat.app.data.Accelerator
import com.edgecat.app.data.BuiltInTaskId
import com.edgecat.app.data.Category
import com.edgecat.app.data.CategoryInfo
import com.edgecat.app.data.Config
...
import com.edgecat.app.data.EMPTY_MODEL
import com.edgecat.app.data.IMPORTS_DIR
import com.edgecat.app.data.Model
import com.edgecat.app.data.ModelAllowlist
import com.edgecat.app.data.ModelDownloadStatus
import com.edgecat.app.data.ModelDownloadStatusType
import com.edgecat.app.data.NumberSliderConfig
import com.edgecat.app.data.RuntimeType
import com.edgecat.app.data.SOC
import com.edgecat.app.data.TMP_FILE_EXT
import com.edgecat.app.data.Task
import com.edgecat.app.data.ValueType
import com.edgecat.app.data.createLlmChatConfigs
import com.edgecat.app.proto.AccessTokenData
import com.edgecat.app.proto.ImportedModel
import com.edgecat.app.proto.Theme
...
private const val ALLOWLIST_BASE_URL =
  "https://raw.githubusercontent.com/blayer/EdgeCat/refs/heads/main/android-app/model_allowlists"
