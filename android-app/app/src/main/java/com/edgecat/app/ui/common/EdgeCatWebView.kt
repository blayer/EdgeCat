...
private const val TAG = "AGEdgeCatWebView"
...
/**
 * A base [WebViewClient] for [EdgeCatWebView] that handles local asset loading and logs page
 * finishing.
 */
open class BaseEdgeCatWebViewClient(private val context: Context) : WebViewClient() {
...
fun EdgeCatWebView(
  ...
  val curWebViewClient = remember {
    customWebViewClient ?: BaseEdgeCatWebViewClient(context = context)
  }
