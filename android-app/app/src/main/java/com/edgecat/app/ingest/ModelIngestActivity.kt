...
package com.edgecat.app.ingest
 ...
 *
 *   adb push model.litertlm /sdcard/Android/data/com.edgecat.app/files/model.litertlm
 *   adb shell am start \
 *     -a com.edgecat.app.MODEL_INGEST \
 *     -n com.edgecat.app/.ingest.ModelIngestActivity \
