...
// at edgecat://hf-callback, exchange the code for a token, store it via
...
public enum HuggingFaceOAuthSession {
    ...
    public static let redirectScheme = "edgecat"
    public static let redirectURL = "edgecat://hf-callback"
