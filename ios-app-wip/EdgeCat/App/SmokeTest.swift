...
// EDGECAT_TEST_PROMPT is set. Loads the first .litertlm in Documents/Models/,
// sends the prompt, and logs streamed tokens to stdout — no UI tap required.
//
// Usage:
//   xcrun simctl launch --console <udid> com.edgecat.app \
//     EDGECAT_TEST_PROMPT="What is the capital of France?"

enum SmokeTest {
    static func runIfRequested() {
        guard let prompt = ProcessInfo.processInfo.environment["EDGECAT_TEST_PROMPT"],
