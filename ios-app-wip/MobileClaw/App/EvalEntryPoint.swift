...
// invokes the app via:
//
//   xcrun simctl launch --setenv MOBILECLAW_EVAL_MODE=1 <udid> <bundle-id>
//   xcrun simctl openurl <udid> \
//     "mobileclaw://eval?prompt=hello&model=gemma-4-E2B-it.litertlm&runId=test1&agentic=1"
//
// EvalRunnerView (rendered when MOBILECLAW_EVAL_MODE=1) shows a minimal
...
public enum EvalEntryPoint {
    ...
    /// Single-instance lock. A second `mobileclaw://eval` URL while a
